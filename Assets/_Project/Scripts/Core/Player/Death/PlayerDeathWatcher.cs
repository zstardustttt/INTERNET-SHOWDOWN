...
namespace Game.Core.Player.Death
{
    ...
    public class PlayerDeathWatcher : MonoBehaviour
    {
        ...
        public void RespawnPlayer(PlayerCore player)
        {
        ...
        public void RegisterDeath(PlayerCore player)
        {
            player.deathModule.Die();
            player.deathModule.respawnTimer = respawnDuration;

            var damages = new Dictionary<PlayerCore, float>();
